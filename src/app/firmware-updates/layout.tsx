...
export const metadata: Metadata = {
  title: "Firmware-updates — Distrixs",
  description:
    "Meld je aan en ontvang automatisch bericht zodra er nieuwe firmware beschikbaar is voor jouw ACME-armatuur.",
};

export default function FirmwareUpdatesLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-slate-50" style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}>
      ...
      <footer className="max-w-2xl mx-auto px-6 pb-10 text-center text-xs text-slate-400">
        © {new Date().getFullYear()} Distrixs ·{" "}
        <a href="mailto:info@distrixs.nl" className="hover:text-slate-600">
          info@distrixs.nl
        </a>
      </footer>
    </div>
